                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="name" class="form-control border-start-0 @error('name') is-invalid @enderror form-control-sm" value="{{ old('name') }}" placeholder="Enter role name" required>
