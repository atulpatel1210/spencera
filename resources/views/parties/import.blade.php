            ...
            <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                <div class="card-header bg-white py-3 px-4 border-bottom d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-primary">
                        <i class="fas fa-file-import me-2"></i> Import Parties
                    </h5>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ route('parties.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-grid gap-3 d-md-flex justify-content-md-center mt-5 pt-3">
                            <a href="{{ route('parties.download-sample') }}" class="btn btn-outline-secondary btn-lg px-4 border fw-medium rounded-pill">
