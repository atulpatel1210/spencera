            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-white py-3 px-4 border-bottom d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-primary">
                        <i class="fas fa-plus-circle me-2"></i> Create New Party
                    </h5>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control border-start-0 bg-light @error('party_name') is-invalid @enderror form-control-sm" id="party_name" name="party_name" value="{{ old('party_name') }}" placeholder="Enter party name" required autofocus>
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control border-start-0 bg-light @error('gst_no') is-invalid @enderror form-control-sm" id="gst_no" name="gst_no" value="{{ old('gst_no') }}" placeholder="e.g. 24ABCDE1234F1Z5">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control border-start-0 bg-light @error('contact_person') is-invalid @enderror form-control-sm" id="contact_person" name="contact_person" value="{{ old('contact_person') }}" placeholder="Full Name">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="email" class="form-control border-start-0 bg-light @error('email') is-invalid @enderror form-control-sm" id="email" name="email" value="{{ old('email') }}" placeholder="name@example.com">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold text-secondary small text-uppercase">Contact No</label>
                             <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control border-start-0 bg-light @error('contact_no') is-invalid @enderror form-control-sm" id="contact_no" name="contact_no" value="{{ old('contact_no') }}" placeholder="Landline / Other">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control border-start-0 bg-light @error('mobile_no') is-invalid @enderror form-control-sm" id="mobile_no" name="mobile_no" value="{{ old('mobile_no') }}" placeholder="Mobile Number">
                         ...
                         <div class="col-12">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <textarea class="form-control border-start-0 bg-light @error('address') is-invalid @enderror form-control-sm" id="address" name="address" rows="3" placeholder="Full Billing Address">{{ old('address') }}</textarea>
