            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <h5 class="card-title text-primary">
                        <i class="fas fa-paint-roller me-2"></i> Finish Management
                    </h5>
                    <div class="d-flex gap-2">
                        <a href="{{ route('finishes.create') }}" class="btn btn-primary px-4">
                            <i class="fas fa-plus me-1"></i> Add Finish
                        </a>
                        <a href="{{ route('finishes.import.form') }}" class="btn btn-light border px-4">
