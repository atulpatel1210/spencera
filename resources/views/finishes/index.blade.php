            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-white py-3 px-4 border-bottom d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <h5 class="mb-0 fw-bold text-primary">
                        <i class="bi bi-paint-bucket me-2"></i> Finish Management
                    </h5>
                    <div class="d-flex gap-2">
                        <a href="{{ route('finishes.create') }}" class="btn btn-primary rounded-pill shadow-sm px-4">
                            <i class="bi bi-plus-lg me-1"></i> Add Finish
                        </a>
                        <a href="{{ route('finishes.import.form') }}" class="btn btn-outline-secondary rounded-pill shadow-sm px-4">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0" id="finishes-table">
...
<style>
    ...
    #finishes-table tbody td {
        padding: 1rem 1rem;
        color: #495057;
        border-bottom: 1px solid #f1f1f1;
    }
    #finishes-table tbody tr:hover {
        background-color: #f8f9fa;
        transition: background-color 0.2s ease-in-out;
    }
    #finishes-table_wrapper .dataTables_length select {
        border-radius: 0.5rem;
        padding: 0.375rem 2.25rem 0.375rem 0.75rem;
        border: 1px solid #dee2e6;
    }
    #finishes-table_wrapper .dataTables_filter input {
        border-radius: 0.5rem;
        border: 1px solid #dee2e6;
        padding: 0.375rem 0.75rem;
    }
    #finishes-table_wrapper .dataTables_paginate .paginate_button.current {
        background: #0d6efd !important;
        color: white !important;
        border: none !important;
        border-radius: 0.375rem !important;
    }
    #finishes-table_wrapper .dataTables_paginate .paginate_button:hover {
...
$(function() {
    $('#finishes-table').DataTable({
        ...
        columns: [
            ...
            { data: 'finish_name', name: 'finish_name', className: 'fw-semibold text-dark' },
