<div class="sidebar">
    <h4 class="text-center logo"><img src="https://spenceraceramica.com/images/logo/white.svg" alt=""></h4>
    ...
    <a href="{{ route('finishes.index') }}" class="{{ request()->routeIs('finishes.index') ? 'active' : '' }}">
        <i class="fas fa-paint-roller"></i> Finish
    </a>
    ...
    <a class="nav-link {{ request()->routeIs('stock-pallets.report') ? 'active' : '' }}" href="{{ route('stock-pallets.report') }}">
        <i class="nav-icon fas fa-warehouse"></i> Stock Pallet Report
    </a>
