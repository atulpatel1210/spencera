                    ...
                    <div class="mb-5">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control form-control-lg shadow-sm" id="order_remark" name="remark" rows="5" placeholder="Optional remark for the entire order">{{ old('remark') }}</textarea>
                            </div>
                        </div>
                    </div>
