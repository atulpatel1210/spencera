                    ...
                    <div class="mb-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-3">
                                ...
                                <div class="input-group input-group-lg shadow-sm input-group-sm">
                                    ...
                                    <input type="text" class="form-control border-start-0 bg-white form-control-sm" id="po" name="po" required value="{{ old('po') }}" placeholder="Ex: PO-2024-001">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3">
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <div class="input-group input-group-lg shadow-sm input-group-sm">
                                    ...
                                    <input type="text" class="form-control border-start-0 bg-white form-control-sm" id="brand_name" name="brand_name" placeholder="Enter Brand" value="{{ old('brand_name') }}">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3">
                                ...
                                <div class="input-group input-group-lg shadow-sm input-group-sm">
                                    ...
                                    <input type="date" class="form-control border-start-0 bg-white form-control-sm" id="order_date" name="order_date" value="{{ old('order_date', date('Y-m-d')) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control form-control-lg shadow-sm form-control-sm" id="order_remark" name="remark" rows="5" placeholder="Optional remark for the entire order">{{ old('remark') }}</textarea>
                            </div>
                        </div>
                    </div>
    ...
    document.addEventListener("click", function(e) {
        if (e.target && e.target.id === "addMorePalletBtn") {
            ...
            <div class="row g-3 pallet-row mt-2">
                <div class="col-md-3">
                    <input type="number" class="form-control box_pallet form-control-sm" oninput="calculatePalletRowTotal(this);" placeholder="Box Per Pallet">
                </div>
                <div class="col-md-3">
                    <input type="number" class="form-control total_pallet form-control-sm" oninput="calculatePalletRowTotal(this);" placeholder="Total Pallet">
                </div>
                <div class="col-md-3">
                    <input type="number" class="form-control total_boxe_pallets form-control-sm" placeholder="Total Boxes (Pallet)" readonly>
                </div>
    ...
    function editItem(index) {
        ...
        if (hasPallet) {
            ...
            for (let i = 1; i < item.pallets.length; i++) {
                ...
                <div class="row g-3 pallet-row mt-2">
                    <div class="col-md-3">
                        <input type="number" class="form-control box_pallet form-control-sm" oninput="calculatePalletRowTotal(this);" placeholder="Box Per Pallet" value="${p.box_pallet}">
                    </div>
                    <div class="col-md-3">
                        <input type="number" class="form-control total_pallet form-control-sm" oninput="calculatePalletRowTotal(this);" placeholder="Total Pallet" value="${p.total_pallet}">
                    </div>
                    <div class="col-md-3">
                        <input type="number" class="form-control total_boxe_pallets form-control-sm" placeholder="Total Boxes (Pallet)" value="${finalTotal}" readonly>
                    </div>
                    <div class="col-md-2 d-flex align-items-center">
                        <button type="button" class="btn btn-danger btn-sm removePallet">X</button>
                    </div>
